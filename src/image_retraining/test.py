...
def main(_):
  ...
  label2idx, idx2label, label2name = create_label_lists(
      FLAGS.label_dir, FLAGS.label_file,
      FLAGS.json_dir, FLAGS.json_file
  )
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--model_source_dir',
      type=str,
      default='C:\\Users\\weihan\\Courses\\COSEngProj\\tmp3',
      help="""\
  ...
  parser.add_argument(
      ...
      default='C:\\Users\\weihan\\Courses\\COSEngProj\\tmp3',
      help="""\
        directory containing the output label list.\
        """)
  ...
  parser.add_argument(
      '--json_dir',
      type=str,
      default='D:\\PycharmProjects\\product-image-dataset-v0.1',
      help="""\
          directory containing the json file of product information.\
          """)
  ...
  parser.add_argument(
      '--test_result_path',
      type=str,
      default='C:\\Users\\weihan\\Courses\\COSEngProj\\tmp3\\training_results.pkl',
      help="""\
