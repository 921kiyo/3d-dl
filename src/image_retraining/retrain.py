...
if __name__ == '__main__':
  ...
  def resolve_paths(FLAGS):
    FLAGS.bottleneck_dir = os.path.join(FLAGS.output_dir,FLAGS.bottleneck_dir)
    FLAGS.output_graph = os.path.join(FLAGS.output_dir,FLAGS.output_graph)
    FLAGS.intermediate_output_graphs_dir = os.path.join(FLAGS.output_dir, FLAGS.intermediate_output_graphs_dir)
    FLAGS.output_labels = os.path.join(FLAGS.output_dir, FLAGS.output_labels)
    FLAGS.summaries_dir = os.path.join(FLAGS.output_dir, FLAGS.summaries_dir)
    FLAGS.model_dir = os.path.join(FLAGS.output_dir, FLAGS.model_dir)
    return FLAGS

  FLAGS = resolve_paths(FLAGS)
