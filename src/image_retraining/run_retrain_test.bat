...
python ./tf_eval.py --model_source_dir $train_output_dir --label_path $train_output_dir/output_labels.txt --test_file_dir $test_file_dir --test_result_path $train_output_dir/test_results.pkl --num_test 100
