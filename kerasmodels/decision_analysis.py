...
plt.title('P max-log-confidence | correct classification')
plt.grid()
...
plt.ylabel('PDF')
plt.legend(['estimated exponential distribution', 'density histogram'])
plt.title('P max-log-confidence | incorrect classification')
plt.grid()
...
plt.ylabel('PDF')
plt.legend(['estimated exponential distribution', 'density histogram'])
plt.title('P max-log-confidence (marginal)')
plt.grid()
...
plt.xlabel('max-log-confidence')
plt.ylabel('PDF')
plt.legend(['P(correct | max-log-confidence)', 'P(incorrect | max-log-confidence)'])
plt.title('Posterior distribution of classifications given max-log-confidence values')
plt.grid()
